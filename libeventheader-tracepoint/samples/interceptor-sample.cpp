...
// A program can have multiple providers.
// In this case, we set the group name.
TRACELOGGING_DEFINE_PROVIDER(
    OtherProvider,
    "OtherProviderName",
...
int main(int argc, char* argv[])
{
    ...
    // The rest of the program is the same as provider-sample.cpp, i.e. the same as
    // when using the default (libtracepoint) implementation:
