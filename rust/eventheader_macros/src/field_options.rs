...
pub static FIELD_OPTIONS: &[Opt] = &[
    ...
    Opt::new("ipv6",                    U8_PATH,    E::StringLength16Char8, F::IPv6,            Str,        16),
    Opt::new("ipv6c",                   U8_PATH,    E::StringLength16Char8, F::IPv6,            Str,        16),
    ...
    Opt::new("posix_error",             I32_PATH,   E::Value32,             F::Errno,           Scalar,     0),
    Opt::new("posix_error_slice",       I32_PATH,   E::Value32,             F::Errno,           Slice,      0),
    Opt::new("posix_time32",            I32_PATH,   E::Value32,             F::Time,            Scalar,     0),
    Opt::new("posix_time32_slice",      I32_PATH,   E::Value32,             F::Time,            Slice,      0),
    Opt::new("posix_time64",            I64_PATH,   E::Value64,             F::Time,            Scalar,     0),
    Opt::new("posix_time64_slice",      I64_PATH,   E::Value64,             F::Time,            Slice,      0),
